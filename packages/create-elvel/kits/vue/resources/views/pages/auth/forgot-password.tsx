 ...
 *
 * `AuthPageController` answers /forgot-password with the document the Vue client boots from,
 * and the Vue page at `frontend/src/views/auth/ForgotPassword.vue` is what you edit. The auth
 ...
 */
export function ForgotPassword(_props: { title: string; error?: string; sent: boolean }): string {
  return ''
}
