 ...
 *
 * `AuthPageController` answers /two-factor-challenge with the document the Vue client boots from,
 * and the Vue page at `frontend/src/views/auth/TwoFactorChallenge.vue` is what you edit. The auth
