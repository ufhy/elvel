 ...
 *
 * `AuthPageController` answers /sign-in with the document the Vue client boots from,
 * and the Vue page at `frontend/src/views/auth/SignIn.vue` is what you edit. The auth
 ...
 */
export function SignIn(_props: { title: string; error?: string }): string {
  return ''
}
