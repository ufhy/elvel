 ...
 *
 * A handler is either a closure or `[Controller, 'method']`. Both pages below are
...
Route.get('/', () =>
  view(Welcome, {
     ...
     * sign-in names them and it fills in. A starter page must not link to a
     * page the application does not have.
     */
    links: {
