...
What is **not** in these pages yet is most of it. Eighteen of the twenty-seven
packages are documented here; the other nine — notifications, broadcasting,
concurrency, image, process, http-client, hashing, translation and collections —
have working code, tests against real servers, and no page. They arrive one at a time.
